 ...
 */
export async function getOxfordSetsSummary(supabase: SupabaseClient, userId: string, targetUserId?: string): Promise<OxfordSummaryAnalytics> {
    
  let activeUserId = targetUserId || userId;
 ...
 */
export async function getSetDetailsAnalytics(supabase: SupabaseClient, userId: string, setId: string, targetUserId?: string): Promise<OxfordSetAnalytics | null> {
...
export async function getOxfordAnalytics(supabase: SupabaseClient, userId: string, targetUserId?: string): Promise<any> {
  return getOxfordSetsSummary(supabase, userId, targetUserId);
}
