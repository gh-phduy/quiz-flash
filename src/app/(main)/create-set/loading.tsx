            ...
            <div key={i} className="bg-card rounded-xl p-4 sm:p-6">
              ...
              <div className="flex flex-col sm:flex-row gap-6">
                ...
                <div className="sm:w-[120px] shrink-0">
                  <div className="w-full h-24 sm:h-full min-h-[96px] bg-background border-2 border-dashed border-border rounded-lg animate-pulse flex flex-col items-center justify-center gap-2">
                    <div className="w-5 h-5 bg-[#3a466a] rounded animate-pulse"></div>
                    <div className="w-10 h-3 bg-[#3a466a] rounded animate-pulse"></div>
                  </div>
                </div>
